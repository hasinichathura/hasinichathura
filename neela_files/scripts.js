    ...
    (Neela = {
        ...
        events: function() {
            ...
            e = setInterval(function() {
                /loaded|complete/.test(document.readyState) && (clearInterval(e),
                a.resizeVideos())
            }, 10),
            a.contactForm(),
            a.objEvents(),
            ...
            t = setInterval(function() {
                /loaded|complete/.test(document.readyState) && (clearInterval(t),
                a.animateElems())
            }, 10)
        },
        neelaStyle: function() {
        ...
        navigation: function() {
            u(".nav li a").on("click", function(e) {
                var t = u(this)
                  , a = 0;
                if (u.browser.mobile && (!t.closest(".dropdown").hasClass("open") || "block" === t.closest(".dropdown-menu").css("display") || !t.parent().parent().hasClass("nav")))
                    return e.preventDefault(),
                    !1;
                "#" === t.attr("href").charAt(0) && u(t.attr("href")).length ? (e.preventDefault(),
                "#hero" !== t.attr("href") && null !== u(t.attr("href")).offset() && (a = u(t.attr("href")).offset().top - 55),
                u("html, body").stop().animate({
                    scrollTop: a
            ...
            0 !== u("#wrapper > section, #wrapper > div#hero").length && this.onepageNav && jQuery().waypoint && u("#wrapper > section, #wrapper > div#hero").waypoint({
                ...
                handler: function(e) {
                    var t = u(this)
                      , a = t[0].element.id;
                    "up" === e && (a = t[0].element.previousElementSibling.id),
                    u(".nav a").removeClass("active"),
                    (u(window).scrollTop() < 100 ? u('.nav a[href="#hero"]') : u('.nav a[href="#' + a + '"]')).addClass("active")
                },
                offset: "50%"
            }),
        ...
        createMobileMenu: function(e) {
            ...
            e <= 975 && !t.mobMenuFlag && (u("body").prepend('<nav class="nav-mobile"><i class="fa fa-times"></i><h2>' + t.mobileMenuTitle + "</h2><ul></ul></nav>"),
            ...
            u(".navbar > a.btn").length && (u(".navbar > a.btn").each(function() {
            ...
            u("#nav-mobile-btn").on(i, function(e) {
                ...
                u(document).on(i, function(e) {
                    u(e.target).hasClass("nav-mobile") || u(e.target).parents(".nav-mobile").length || (o.removeClass("open"),
                    n.removeClass("open"),
                    u(document).off(i))
                }),
                u(">i", n).on(i, function() {
        ...
        heroHeight: function() {
            ...
            u(window).resize(function() {
                ...
                0 < n && u(".v-center").length && u("#hero >.container").css({
                    "margin-top": n / 2 + o + "px"
                }),
                u("#hero").css({
                    minHeight: u(window).innerHeight() + "px"
        ...
        googleMap: function() {
            ...
            if (0 === u(".gmap").length || "undefined" === l.mapMarkers || 0 === l.mapMarkers.length || void 0 === window.google)
                return !1;
            /^\d|\.|-$/.test(l.mapInitialLatitude) && /^\d|\.|-$/.test(l.mapInitialLongitude) || (l.mapInitialLatitude = l.mapMarkers[0].latitude,
            l.mapInitialLongitude = l.mapMarkers[0].longitude),
            t = new google.maps.LatLng(l.mapInitialLatitude,l.mapInitialLongitude),
            l.useDefaultMapStyle || (c = [{
                stylers: [{
                    hue: l.mapColor
                }, {
                    saturation: -75
            ...
            l.rtlFlag && (i = google.maps.ControlPosition.LEFT_CENTER,
        ...
        countdown: function() {
            ...
            u(".countdown").length && (o = function(e, t, a) {
                var n, o = a - new Date;
                if (o < 0)
                    return t.html('<div class="end">' + i.countdownEndMsg + "</div>"),
                    clearInterval(e),
                    !1;
            ...
            u(".countdown").each(function() {
                ...
                n && "[object Date]" === Object.prototype.toString.call(n) && !Number.isNaN(n) && (t = '<div class="days"><div></div><span>' + i.cDays + '</span></div><div class="hours"><div></div><span>' + i.cHours + '</span></div><div class="minutes"><div></div><span>' + i.cMinutes + '</span></div><div class="seconds"><div></div><span>' + i.cSeconds + "</span></div>",
                a.html(t)),
                e = setInterval(function() {
                    o(e, a, n)
                }, 1e3)
            ...
            !u.browser.mobile && 992 < u(window).innerWidth() ? u(window).on("scroll", function() {
                ...
                u(".parallax-background").each(function() {
                    var e = u(this)
                      , t = e.offset().top
                      , a = e.outerHeight();
                    o.isInViewport(this) && (t = n - t,
                    t = Math.round(t / a * 100),
                    e.css("background-position", "center " + parseInt(-t * (a / 250)) + "px"))
                })
        ...
        windowResize: function() {
            ...
            u(window).resize(function() {
                ...
                t.blogMetas(),
                u(window).innerWidth() < 751 && (u(".navbar > a.btn").addClass("btn-sm"),
        ...
        resizeVideos: function() {
            ...
            e.each(function() {
                ...
                (t < .3 || .8 < t || Number.isNaN(t)) && (t = .559),
                e.attr("data-aspectRatio", t).removeAttr("height").removeAttr("width")
            }),
            u(window).resize(function() {
                e.each(function() {
                    var e = u(this)
        ...
        contactForm: function() {
            ...
            u(".submit_form").on("click", function(e) {
                var t, a, n, o = u(this), i = o.closest("form"), s = u("input, textarea, select, fieldset", i), r = 0, l = /\S+@\S+\.\S+/, c = "contact", d = !1;
                return e.preventDefault(),
                n = function(e) {
                ...
                s.each(function() {
                    var e = u(this);
                    "hidden" === e.attr("type") ? e.hasClass("subject") ? c += "&subject=" + n(e.val()) : e.hasClass("fromName") || e.hasClass("fromname") ? c += "&fromname=" + n(e.val()) : e.hasClass("fromEmail") || e.hasClass("fromemail") ? c += "&fromemail=" + n(e.val()) : (e.hasClass("emailTo") || e.hasClass("emailto")) && (c += "&emailto=" + n(e.val())) : "checkbox" === e.attr("type") && 1 === e.parents("fieldset").length && e.parents("fieldset").hasClass("required") || (e.is("fieldset") && e.hasClass("required") && 0 === u("#" + e.attr("id") + " input:checkbox:checked").length ? (u("input", e).addClass("is-invalid"),
                    d = !0) : e.hasClass("required") && "checkbox" === e.attr("type") && !u("input[id='" + e.attr("id") + "']").is(":checked") || e.hasClass("required") && "" === e.val() && "checkbox" !== e.attr("type") && !e.is("fieldset") || e.hasClass("required") && "radio" === e.attr("type") && !u("input[name='" + e.attr("name") + "']").is(":checked") || "email" === e.attr("type") && "" !== e.val() && !1 === l.test(e.val()) ? (e.addClass("is-invalid"),
                    d = !0) : "g-recaptcha-response" !== e.attr("id") && "recaptcha-token" !== e.attr("id") && (e.removeClass("is-invalid"),
                    u("input", e).removeClass("is-invalid"),
                    e.hasClass("subject") ? (c += "&subject=" + n(e.val()),
                    c += "&subject_label=" + n(e.attr("name"))) : e.hasClass("fromName") || e.hasClass("fromname") ? (c += "&fromname=" + n(e.val()),
                    c += "&fromname_label=" + n(e.attr("name"))) : e.hasClass("fromEmail") || e.hasClass("fromemail") ? (c += "&fromemail=" + n(e.val()),
                    c += "&fromemail_label=" + n(e.attr("name"))) : ("radio" === e.attr("type") ? u("input[id='" + e.attr("id") + "']").is(":checked") && (c += "&field" + r + "_label=" + n(e.attr("name")),
                    c += "&field" + r + "_value=" + n(u.trim(u("label[for='" + e.attr("id") + "']").text()))) : e.is("fieldset") ? (c += "&field" + r + "_label=" + n(e.attr("name")),
                    u("#" + e.attr("id") + " input:checkbox:checked").each(function(e) {
                        0 === e ? (c += "&field" + r + "_value=",
                        c += n(u.trim(u("label[for='" + u(this).attr("id") + "']").text()))) : c += ", " + n(u.trim(u("label[for='" + u(this).attr("id") + "']").text()))
                    })) : (c += "&field" + r + "_label=" + n(e.attr("name")),
                    c += "&field" + r + "_value=" + n(e.val())),
                    r += 1)))
                }),
                c += "&len=" + r,
                ...
                ,
                a = function() {
                    u(".fa-spinner", o).remove(),
                    o.removeClass("disabled")
                }
                ,
                d || m.sendingMail ? m.showError() : (m.sendingMail = !0,
                ...
                u.ajax({
                    ...
                    success: function(e) {
                        a(),
                        "ok" === e ? (t(),
                        i[0].reset()) : m.showError(m.contactFormRecaptchaErrorMsg),
                        m.sendingMail = !1,
        ...
        objEvents: function() {
            ...
            u("#about-us .element .image").on("mouseenter", function() {
                var e = u(this);
                if (e.parent().is(":first-child") && !u(">.divider-about-us", e.closest(".row")).hasClass("flip"))
                    return !1;
                e.hasClass("flip") || ((u("#about-us .element .image.flip").length ? u("#about-us .element .image") : e).toggleClass("flip"),
                u(">.divider-about-us", e.closest(".row")).toggleClass("flip"))
            }),
            ...
            u(".nav-logo, .scrollto").on("click", function(e) {
                var t = u(this)
                  , a = 0
                  , n = t.attr("href");
                /#/.test(n) && u(n).length && (e.preventDefault(),
            ...
            u(".progress").length && u(".progress").waypoint(function() {
                u(".progress").each(function() {
                    u("> .progress-bar", u(this)).delay(300).queue(function(e) {
                        var t = u(this);
                        t.css("width", t.attr("aria-valuenow") + "%"),
                        e()
                    })
                })
            }, {
